Системы памяти в искусственном интеллекте: обзор рынка
      ...
      Scope-based halfLife вместо weight decay. Google доказывает: data-dependent decay решает проблему забывания. Мы реализовали тот же принцип, но на уровне данных, а не весов. Законы (115-ФЗ) — halfLife 20 лет. Новости — 180 дней. Скрипты продаж — 5 лет. Recency floor 0.05 — даже старые записи не обнуляются.
