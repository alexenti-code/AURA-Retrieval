...
## Две сущности этого репозитория

Этот репозиторий описывает два разных понятия.

**AURA-Retrieval** — архитектура внешней памяти для мультиагентных AI-систем: композитный скоринг, halfLife по scope, 6 когнитивных ролей и три контура (разделы выше).

**Matryoshka Continuity Weights** — отдельное исследовательское направление: самоорганизующийся пластичный параметрический субстрат автобиографической памяти стабильного языкового ядра. Каноническое определение: [matryoshka/MANIFEST.md](matryoshka/MANIFEST.md). Границы концепции — что Matryoshka не является: [matryoshka/BOUNDARY.md](matryoshka/BOUNDARY.md).

Статьи research-10 … research-14 («Plastic Transformer» / «Матрёшка FWH») — ранние exploratory материалы с предварительной, неканонической терминологией; в них слоистые ядра обсуждаются вместе с safety-фреймворком. Они сохраняются как история исследований и не определяют каноническую Matryoshka Continuity Weights.
